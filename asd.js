(function() {
    ...
    function startPlugin() {
        ...
        var manifst = {
            ...
            onContextMenu: function onContextMenu(object) {
                return {
                    name: Lampa.Lang.translate('animelib_watch'),
                    description: ''
                };
            },
                ...
                },
                {
                    ...
                    onClick: async function() {
                        try {
                            ...
                            if (token) {
                                Lampa.Notify.show('✅ Токен работает!', 'AnimeLib');
                            } else {
                                Lampa.Notify.show('❌ Токен не найден', 'AnimeLib');
                            }
                        } catch (e) {
    ...
    // Запуск плагина
    if (!window.animelib_plugin_started) {
        window.animelib_plugin_started = true;
